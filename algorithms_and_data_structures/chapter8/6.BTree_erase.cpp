/*************************************************************************
	> File Name: 5.BTree.cpp
	> Author: huang
	> Mail: 1309107123@qq.com
	> Created Time: Wed 25 Sep 2024 04:56:05 PM CST
 ************************************************************************/
...
void right_rotate(Node *root, int pos) {
    for (int i = RCHILD(root, pos)->n + 1; i >= 0; i--) { // ? i >= 0
